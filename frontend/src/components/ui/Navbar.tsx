...
const NavItem = ({ href, icon: Icon, label, badge }: NavItemProps) => {
    ...
    return (
        <Link
            href={href}
            className={cn(
                "flex flex-col items-center justify-center min-w-[64px] md:min-w-[80px] transition-all relative group py-1",
...
export default function Navbar() {
    return (
        <nav className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
            <div className="max-w-6xl mx-auto flex items-center justify-between h-[52px] px-4">

                <div className="flex items-center flex-1 gap-2">
                    <Link href="/" className="flex-shrink-0">
                        <div className="bg-[#0A66C2] text-white rounded-[4px] font-bold text-xl w-8 h-8 flex items-center justify-center">
                            N
                        </div>
                    </Link>
                    ...
                    <div className="relative max-w-[280px] w-full hidden sm:block">
                        ...
                        <input
                            type="text"
                            placeholder="Search"
                            className="bg-[#edf3f8] border-none rounded-[4px] py-1.5 pl-10 pr-4 w-full text-sm focus:ring-2 focus:ring-black outline-none transition-all placeholder:text-gray-600"
                        />
                    </div>
                ...
                <div className="flex items-center h-full">
                    ...
                    <div className="hidden md:block h-full w-[1px] bg-gray-200 mx-2" />
