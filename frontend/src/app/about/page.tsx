    ...
    return (
        <InfoLayout title="About NConnect" subtitle="Connecting the world&apos;s social impact professionals.">
            <div className="space-y-6 sm:space-y-8">
                <section>
                    <h2 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-slate-800">Our Mission</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 my-8 sm:my-10">
                    {[
                        ...
                        <div key={s.label} className="text-center p-5 sm:p-6 border border-slate-100 rounded-xl bg-slate-50">
                            <div className="text-2xl sm:text-3xl font-bold text-indigo-600">{s.val}</div>
                            <div className="text-slate-500 text-xs sm:text-sm uppercase tracking-wider mt-1">{s.label}</div>
                        </div>
                    ))}
                </div>
            </div>
