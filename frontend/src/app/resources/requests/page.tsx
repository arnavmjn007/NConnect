...
import { CheckCircle, XCircle, Clock, Package, MessageSquare } from 'lucide-react';
                    ...
                    <>
                        ...
                        {past.length > 0 && (
                            <div className="space-y-3">
                                ...
                                {past.map(req => (
                                    <div key={req.id} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 flex items-center justify-between gap-3">
