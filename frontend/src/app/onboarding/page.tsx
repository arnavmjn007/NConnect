...
const SKILLS = [
    ...
    "Teaching", "Fundraising", "Project Management",
    "Community Outreach", "Social Media", "Event Planning",
    "Data Analysis", "Medical", "Legal", "Translation",
];

const INTERESTS = [
    "Education", "Environment", "Healthcare", "Women Empowerment",
    "Children & Youth", "Animals", "Disaster Relief",
    "Food Security", "Clean Water", "Digital Literacy",
    "Mental Health", "Human Rights",
];

const CAUSES = [
    "Education Access", "Climate Action", "Poverty Alleviation",
    "Gender Equality", "Clean Energy", "Zero Hunger",
    "Quality Healthcare", "Clean Water & Sanitation",
];

const LANGUAGES = [
    "English", "Nepali", "Hindi", "Mandarin",
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8">
                        ...
                        {step === 1 && (
                            <div className="space-y-5">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">This is how others will find and recognise you.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        placeholder="I'm a software engineering student passionate about education and sustainability..."
                                        value={form.bio}
                                    ...
                                    <p className="text-[11px] text-slate-400 mt-1">
                                        This helps us match you with the right NGOs and projects.
                                    </p>
                                </div>
                        ...
                        {step === 2 && (
                            <div className="space-y-6">
                                <div>
                                    <h1 className="text-xl font-bold text-slate-900">Your skills & languages</h1>
                                    <p className="text-sm text-slate-500 mt-1">Select all that apply — this powers volunteer matching.</p>
                                </div>
                        ...
                        {step === 3 && (
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-500 mt-1">We will personalize your feed and recommendations.</p>
                                </div>
