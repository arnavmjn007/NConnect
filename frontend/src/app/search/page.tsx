...
interface SearchResults {
    ...
    ngos: Array<{ id: string; username: string; organizationName: string; location: string | null; ngoCategories: string | null; verified: boolean; verificationStatus: string }>;
                    ...
                    <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        ...
                        <div className="divide-y divide-slate-50">
                            {results.ngos.map(ngo => (
                                <Link key={ngo.id} href={`/profile/${ngo.username}`}
                                    ...
                                    <button className="shrink-0 border border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white text-xs font-bold px-4 py-1.5 rounded-full transition-all">
                                        Follow
                                    </button>
                                </Link>
                            ))}
                        ...
                        <div className="divide-y divide-slate-50">
                            {results.users.map(u => (
                                <Link key={u.id} href={`/profile/${u.username}`}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="font-bold text-slate-900">{u.fullName || u.username}</p>
                                    ...
                                    <button className="shrink-0 border border-slate-300 text-slate-600 hover:border-indigo-600 hover:text-indigo-600 text-xs font-bold px-4 py-1.5 rounded-full transition-all">
                                        Connect
                                    </button>
                                </Link>
                            ))}
