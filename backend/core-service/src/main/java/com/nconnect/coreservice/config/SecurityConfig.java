...
public class SecurityConfig {
    ...
    public SecurityConfig(SuspensionCheckFilter suspensionCheckFilter) {
        this.suspensionCheckFilter = suspensionCheckFilter;
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAfter(suspensionCheckFilter, BearerTokenAuthenticationFilter.class);
        return http.build();
    }
